...
if (!$smarty->is_cached('category.dwt', $cache_id))
{
	...
	$smarty->assign('p_id',       get_parent_cat_id($cat_id));//888
	$smarty->assign('top_id',       get_top_cat_id($cat_id));//888
	...
	require(ROOT_PATH . 'themes/meilele/php/category.php');//888
...
$smarty->display('category_songbei.dwt', $cache_id);

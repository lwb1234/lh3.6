...
//by lee 商户管理增加 start
// 商户的权限
//$purview['01_goodHs_list']        = array('goodHs_manage', 'remove_back');
//$purview['02_goodHs_add']         = 'goodHs_manage';
//$purview['03_category_listH']     = array('cat_manage', 'cat_drop');   //分类添加、分类转移和删除
//$purview['08_goodHs_type']        = 'attr_manage';   //商品属性
//$purview['11_goodHs_trash']       = array('goodHs_manage', 'remove_back');

/* 商家入驻 20150718*/
$purview['check'] = 'check'; //审核商家商品信息
/*商家入驻*/

// 添加秒杀管理 by lee 20170921   start
$purview['16_seckill']        = 'seckill';  // 秒杀权限
// 添加秒杀管理 by lee 20170921   end

//促销管理权限
$purview['02_snatch_list']       = 'snatch_manage';
//入驻商家管理权限 wang 商家入驻 start20150718
$purview['02_seller_fields']       = 'seller_fields'; // 商家注册项设置
$purview['01_goodHs_list']           = 'seller_manage'; // 商家列表管理权限
$purview['seller_yongjin']           = 'seller_yj_manage'; // 商家列表管理权限
$purview['seller_goods_list']        = 'seller_goods_manage';   //商户商品
$preview['02_goodHs_add']            = 'seller_add_manage' ;    //添加新的商户
$purview['03_category_listH']       ='store_cate_manage';//商家店铺分类管理权限
$purview['08_goodHs_type']          = 'store_type_mangage'; // 商户类型管理
$purview['10_seller_category_manege']       = 'seller_category_manege'; //商户店铺管理
$purview['11_goodHs_trash']          = 'store_trash_mangage'; // 商户回收管理



$purview['store_goods']='store_goods_manage';//商家货物分类管理权限

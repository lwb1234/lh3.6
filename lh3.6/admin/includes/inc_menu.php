...
//添加商户菜单链接 在前台显示这里很重要
$modules['02_cat_and_goodHs']['02_seller_fields']    = 'seller_fields.php?act=list';   // 商户注册项设置
$modules['02_cat_and_goodHs']['01_goodHs_list']       = 'user_sellers.php?act=list';         // 入驻商户列表
$modules['02_cat_and_goodHs']['seller_yongjin']       = 'seller_commission.php?act=list';      //佣金列表
//$modules['02_cat_and_goodHs']['02_goodHs_add']        = 'goodHs.php?act=add';          // 添加商户
$modules['02_cat_and_goodHs']['03_category_listH']    = 'store_category.php?act=list';        //商户分类
$modules['02_cat_and_goodHs']['seller_goods_list']    = 'store_goods.php?act=list';//商户商品
$modules['02_cat_and_goodHs']['10_seller_category_manege']  = 'store_manege.php?act=list'; //商户店铺管理
//$modules['02_cat_and_goodHs']['11_goodHs_trash']      = 'goodHs.php?act=trash';        // 商户回收站
$modules['02_cat_and_goodHs']['street_tags_manege']   = 'street_tags_manege.php?act=list';// 店铺街标签管理
...
//添加左侧菜单秒杀管理超链接 by lee 2017 0921  start 这里是添加菜单位置的地方
$modules['03_promotion']['16_seckill']       = 'seckill_goods.php?act=list';
//添加左侧菜单秒杀管理超链接 by lee 2017 0921  end

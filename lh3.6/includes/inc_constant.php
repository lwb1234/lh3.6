...
/*by lee 增加商品类型*/
define('CART_SECKILL_BUY_GOODS',      5); // 秒杀商品
...
/* 秒杀活动状态 */
define('SBS_PRE_START',             0); // 未开始
define('SBS_UNDER_WAY',             1); // 进行中
define('SBS_FINISHED',              2); // 已结束
define('SBS_SUCCEED',               3); // 秒杀成功（可以发货了）
define('SBS_FAIL',                  4); // 秒杀失败

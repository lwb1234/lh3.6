...
<div class="Left main_map JC_focus" id="JS_focus_locker">
  <div class="stage">
    <table id="JS_focus_table">
      <tr>
	  <?php $_from = get_channel_flash_advlist_songbei($GLOBALS[smarty]->_var[category]); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
?>
        <td><a title="<?php echo $this->_var['ad']['name']; ?>" target="_blank" href="<?php echo $this->_var['ad']['url']; ?>"><img src="themes/meilele/images/blank.gif" data-src="<?php echo $this->_var['ad']['image']; ?>" alt="<?php echo $this->_var['ad']['name']; ?>" width="1190" height="370" /></a></td>
	  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	

      </tr>
    </table>
  </div>
  <div class="nav clearfix" id="JS_focus_nav"><?php $_from = get_channel_flash_advlist_songbei($GLOBALS[smarty]->_var[category]); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
...
<div class="w mt20 floor1 floor1_2">
  ...
  <div class="main_new" id="JS_hover_img_box_2"><?php $_from = get_songbei_advlist_by_id(1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
...
<div class="w mt20 floor1">
  ...
  <div class="main_new" id="JS_hover_img_box_1"><?php $_from = get_songbei_advlist_by_id(2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;

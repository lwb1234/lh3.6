...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <!--去掉虚拟价格增加 审核状态-->
    <th>审核状态</th>
    <!--<th><a href="javascript:listTable.sort('virtual_sales'); "><?php echo $this->_var['lang']['virtual_sales']; ?></a><?php echo $this->_var['sort_virtual_sales']; ?></th>-->
...
?>
  <tr>
    ...
    <?php endif; ?>
    <td align="center">
      <?php if ($this->_var['goods']['check_status'] == 0): ?>未审核<?php elseif ($this->_var['goods']['check_status'] == 1): ?>审核通过<?php else: ?><span title="<?php echo $this->_var['goods']['check_cause']; ?>">审核不通过</span>
      <?php endif; ?>
    </td>
    <!--<td align="center"><span onclick="listTable.edit(this, 'edit_virtual_sales', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['virtual_sales']; ?></span></td>-->
    <td align="center">

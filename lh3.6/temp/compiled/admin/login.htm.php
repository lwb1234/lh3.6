...
.panel-hint{top: 3%;}
<?php if ($this->_var['yunqi_bg']): ?>
.login-body{ background: url(<?php echo $this->_var['yunqi_bg']; ?>) no-repeat center center; }
<?php else: ?>
...
<form class="login-body" method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  ...
  <div class="center-wrap" id="centerWrap">
    ...
    <div class="top-ibg-wrap">
      <a style="background: url(<?php echo $this->_var['yunqi_ad_link']; ?>) no-repeat center;" href="<?php echo $this->_var['yunqi_ad_url']; ?>" target="_blank" class="top-ibg-480600"></a>
    </div>
    <div class="z-bd">
    <div class="message"><?php echo $this->_var['login_err']; ?></div>
      ...
      <div class="login-cloud" id="elseLogin">
        <div class="hd"><?php echo $this->_var['lang']['other_login_methods']; ?></div>
        ...
        <p><?php echo $this->_var['lang']['yunqi_account']; ?></p>
      </div>
    </div>
  </div>
  <input type="hidden" name="act" value="signin" />
</form>
<div class="copy-right">&copy; 2003-<?php echo $this->_var['now_year']; ?> ShopEx,Inc.All rights reserved.</div>
<script language="JavaScript">
...
<!--
  ...
  var dom ="<h3 class='logo-text yunqi-logo'><div class='logo'></div><p class='text'>云起登录</p></h3><div class='main'><span class='error-hint' <?php if (! $this->_var['error_msg']): ?> style='display:none' <?php endif; ?> id='login_error_msg'><?php echo $this->_var['error_msg']; ?></span><iframe id='loginFrame' src='<?php echo $this->_var['iframe_url']; ?>' height='220' frameborder='0' scrolling='no'></iframe><div class='cloud-passw'><a target='_blank' href='https://account.shopex.cn/forget?' style='float:right;'><?php echo $this->_var['lang']['forget_pwd']; ?></a></div> </div>";

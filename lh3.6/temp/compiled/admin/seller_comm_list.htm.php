...
<div class="form-div">
  <form action="javascript:searchOrder()" name="searchForm">
    ...
    商家账号<input name="user_name" type="text" id="user_name" size="15">
...
?>
  <tr>
    ...
    <td align="center" valign="top" nowrap="nowrap">￥<?php echo $this->_var['comm']['total_turnover']; ?>元</td>
    ...
    <td align="center" valign="top" nowrap="nowrap"><?php echo $this->_var['comm']['operator']; ?></td>

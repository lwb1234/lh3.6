...
?>
	<a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank" style="display:block" title="<?php echo $this->_var['ad']['name']; ?>"><img data-src2="/<?php echo $this->_var['ad']['image']; ?>" src="/themes/meilele/images/blank.gif" width="228" height="102" alt="<?php echo $this->_var['ad']['name']; ?>" /></a>
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	</div>
    <div class="tab mt10">
...
?>
      <div class="goods4_list first">
        <div class="img"><?php if ($this->_var['goods']['save_rate'] > 0): ?><span class="yahei"><strong><?php echo $this->_var['goods']['save_rate']; ?></strong><br>折
        </span><?php endif; ?><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><img src="/themes/meilele/images/blank.gif" data-src2="/<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" /></a> </div>
        <div name  = ' id'>促销 </div>
 ...
 <?php echo $this->fetch('library/seckill_bujia.lbi'); ?>
...
?>
    <div class="goods4_list mt20 <?php if ($this->_foreach['get_cat_new_goods_5']['iteration'] == 1): ?>first<?php endif; ?><?php if ($this->_foreach['get_cat_new_goods_5']['iteration'] == 5): ?>SCREEN-SHOW<?php endif; ?>">
      <div class="img"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><img src="/themes/meilele/images/blank.gif" data-src2="/<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" /></a> </div>

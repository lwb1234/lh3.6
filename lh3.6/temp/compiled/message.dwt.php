...
<div class="block">
  <div class="box">
   <div class="box_1" style="border:1px solid #e2e2e2">
    <h3 style="border:0px; border-bottom:1px solid  #e2e2e2"><span><?php echo $this->_var['lang']['system_info']; ?></span></h3>
    <div class="boxCenterList RelaArticle" align="center" style="">

    ...
    <div class="box">
      <div class="box_1">
        <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
		  ...
		  <div style="border:1px solid #eee; padding:10px 10px; " class="clearfix">
          ...
          <?php endif; ?>
          <div style="margin:5px 0; border:1px solid RGB(234,202,165);padding:10px 20px; background-color:RGB(255,250,227);"> <img src="themes/meilele/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?> </div>
          <br />
          <br />
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
            <table width="100%" border="0" cellpadding="3">
              ...
              <tr>
                ...
                <td><a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/meilele/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
              ...
              <tr>
                ...
                <td><input type="hidden" name="act" value="act_add_message" />
                  <input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>"  class="btn_submit"/>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
...
?>
          <div class="f_l"> <b> <?php if ($this->_var['comment']['comment_type'] == '1'): ?>
            <?php echo $this->_var['lang']['article_comment']; ?>
            <?php elseif ($this->_var['comment']['comment_type'] == '2'): ?>
            商品提问
            <?php else: ?>
            <?php echo $this->_var['lang']['goods_comment']; ?>
            <?php endif; ?>
            : </b><font class="f4"><?php echo $this->_var['comment']['cmt_name']; ?></font>&nbsp;&nbsp;(<?php echo $this->_var['comment']['formated_add_time']; ?>) </div>
          ...
          <?php if ($this->_var['action'] == 'account_lock'): ?>
          <h5><span>Facebook account binding</span></h5>
          <div class="blank"></div>
          <form action="user.php?act=account_lock" method="post" name="fbind">
            <table>
              <tr>
                <td> <?php if ($this->_var['fbindid'] == ''): ?> <img src="themes/meilele/images/facebook.jpg" width="150px"/> <?php else: ?> <img src="https://graph.facebook.com/<?php echo $this->_var['fbindid']; ?>/picture" align="absmiddle" height="50px" width="50px"> <?php endif; ?> </td>
                <td> <?php if ($this->_var['is_bind'] == '1'): ?>
                  <input type="radio" id="fid2" name="facount" value="1"  checked/>
                  binding</td>
                <?php else: ?>
                <input type="radio" id="fid2" name="facount" value="1" onclick="fbindc(1)"/>
                unbinding
                </td>
                <?php endif; ?>
                <td>
            ...
            <input type="hidden" name="fbindid" id="fbindid"/>
          </form>
          <?php endif; ?>
...
?>
          <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onClick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/meilele/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <?php else: ?>
          ...
          <?php echo $this->smarty_insert_scripts(array('files'=>'transport_new.js,utils.js')); ?>
...
?>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['lang_list'])); ?>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff"><input type="button" name="gen_code" value="<?php echo $this->_var['lang']['generate']; ?>" onClick="genCode()"  class="btn_submit"/></td>
              </tr>
              <tr>
...
?>
    ...
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		  ...
		  <input name="s_id" type="hidden" value="<?php echo $this->_var['info']['seller_id']; ?>" />
                  ...
                  <input type="submit" name="submit" value="<?php echo $this->_var['lang']['submit_booking_goods']; ?>"  class="btn_submit"/>

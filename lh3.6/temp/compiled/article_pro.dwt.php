...
<section class="art_main w clearfix">
  <aside class="art_nav clearfix Left">
	...
	<?php $_from = get_cat_arts_20(2); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_71285300_1510015679');$this->_foreach['artciles_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['artciles_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_71285300_1510015679']):
        $this->_foreach['artciles_list']['iteration']++;
?>
      <li class="art_box"> <a href="<?php echo $this->_var['article_0_71285300_1510015679']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article_0_71285300_1510015679']['title']); ?>" name="JS_art_title" class="art_box_title <?php if ($this->_var['article_0_71285300_1510015679']['id'] == $this->_var['id']): ?>current<?php endif; ?>" id="JS_art_1"><?php echo htmlspecialchars($this->_var['article_0_71285300_1510015679']['title']); ?><span>COMPANY</span></a> </li>

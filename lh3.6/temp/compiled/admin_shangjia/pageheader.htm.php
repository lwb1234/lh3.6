...
<?php endif; ?>
<!-- wang 商家入驻-->
<?php if ($this->_var['check_failure']): ?>
<span class="action-span"><a href="<?php echo $this->_var['check_failure']['href']; ?>" style=" color:  #ff6600"><?php echo $this->_var['check_failure']['text']; ?></a></span>
<?php endif; ?>
<?php if ($this->_var['already_check']): ?>
<span class="action-span"><a href="<?php echo $this->_var['already_check']['href']; ?>" style=" color: #009999"><?php echo $this->_var['already_check']['text']; ?></a></span>
<?php endif; ?>
<?php if ($this->_var['not_check']): ?>
<span class="action-span"><a href="<?php echo $this->_var['not_check']['href']; ?>" style=" color:#ff3300"><?php echo $this->_var['not_check']['text']; ?></a></span>
<?php endif; ?>
<!-- wang 商家入驻-->

...
<title>欧式田园	1.8米水晶拉扣双人床 水牛头层真皮床_团购商品_黎华家具装饰材料城-打造老百姓的家具装饰材料电子商城 - Powered by ECShop</title>
...
<div class="tugouWrap w">
  <div class="tg_pos"> 当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="group_buy.php">团购商品</a> <code>&gt;</code> 欧式田园	1.8米水晶拉扣双人床 水牛头层真皮床 </div>
  <div class="tg_dtl_wrap w clearfix">
    <div class="tg_dtl_Left Left">
      <div class="tg_dtl_main">
        <div class="dtl_main_top clearfix">
          <h1 class="Left"><a target="_blank" title="[鸥达] 橡木爵士白雕刻卫浴柜" href="goods.php?id=2">[鸥达] 橡木爵士白雕刻卫浴柜 </a></h1>
          <p class="Right"> 编号：ECS000002 </p>
        </div>
        <span id="JS_user_limit" style="display:none">10000</span>
        <p class="dtl_main_tishi mt15"> （[促销][包物流][直降]【爆款直减620元】模仿得了外貌，模仿不了品质！过万家庭的共同选择，荣获外观设计专利。） </p>
        <div class="dtl_main_info clearfix">
          <form action="group_buy.php?act=buy" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
		  <input type="hidden" name="group_buy_id" value="2" />
			...
			<table width="100%" border="0" cellpadding="5" cellspacing="1" style="background-color:RGB(255,249,239)">
                ...
                <td width="60%"  align="left" style="padding-left:10px;background-color:RGB(255,249,239)">
                    <select name="spec_4" style="border:1px solid #ccc;">
                                        <option label="地中海1.5米床" value="10">地中海1.5米床 </option>
                                        <option label="地中海1.2米床" value="11">地中海1.2米床 </option>
                                        </select>
                </td>
              </tr>
                ...
                <del>￥4296</del></span> <span class="line">折扣 <br>
                <b>4.7折</b></span> <span class="line">节省 <br>
                <b>￥2296</b></span> </div>
              <div class="buyed"> 已团购 <b id="JS_already_number">383</b><span>件</span> <br>
              ...
              <div class="btnbox"> <a title="查看商品详情" target="_blank" href="goods.php?id=2" class="link">查看商品详情</a> </div>
            </div>
          </form>
          <div class="main_infoR Right">
            <p> <a title="欧式田园	1.8米水晶拉扣双人床 水牛头层真皮床 " target="_blank" href="goods.php?id=2"><img width="600" height="400" src="themes/meilele/images/blank.gif" data-src="data/group_img/1385741056654974675.jpg" /></a> </p>
      ...
      <div id="pos_wrap">
        ...
        <div class="tg_dtl_box Left">
          ...
          <script language="javascript">
                 var comment_rank = "45ea207d7a2b68c49582d2d22adf953acomments_rank|a:2:{s:4:"name";s:13:"comments_rank";s:2:"id";s:1:"2";}45ea207d7a2b68c49582d2d22adf953a";
			</script>
      <div class="content pingjia" id="JS_Tab_body_pingjia"><div id="ECS_COMMENT"> 45ea207d7a2b68c49582d2d22adf953acomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";s:1:"0";s:2:"id";s:1:"2";}45ea207d7a2b68c49582d2d22adf953a</div></div>
        </div>
        <div class="tg_dtl_brn Left"> <a href="javascript:;" onClick="ECS_FORMBUY.submit();" class="infobnr" id="JS_down_bnr_state"><b>&yen;</b>2000</a>
          <p class="jiesheng"> 节省<b>￥2296</b>元，数量有限，请抓紧时间下单！ </p>
        </div>
      </div>
    </div>
  </div>

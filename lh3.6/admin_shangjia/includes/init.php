...
/* 取得当前ecshop所在的根目录 */
if(!defined('SJ_ADMIN_PATH'))
{
    define('SJ_ADMIN_PATH','admin_shangjia');
}
define('ROOT_PATH', str_replace(SJ_ADMIN_PATH . '/includes/init.php', '', str_replace('\\', '/', __FILE__)));
...
require(ROOT_PATH . SJ_ADMIN_PATH . '/includes/lib_main.php');
require(ROOT_PATH . SJ_ADMIN_PATH . '/includes/cls_exchange.php');
...
{
    @mkdir('../temp/compiled/admin_shangjia', 0777);
    @chmod('../temp/compiled/admin_shangjia', 0777);
}
...
$smarty->template_dir  = ROOT_PATH . SJ_ADMIN_PATH . '/templates';
$smarty->compile_dir   = ROOT_PATH . 'temp/compiled/'.SJ_ADMIN_PATH;
if ((DEBUG_MODE & 2) == 2)
{

...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('seller_shopslide')."(img_url,img_link, img_desc, is_show, img_order, slide_type,seller_id) ".
           "VALUES ('$img_url', '$img_link', '$img_desc', '$is_show', '$img_order', '$slide_type','".$_SESSION['seller_id']."')";
    $db->query($sql);
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT * FROM " .$ecs->table('seller_shopslide'). " WHERE id='$_REQUEST[id]' and seller_id='".$_SESSION['seller_id']."'";
 ...
 * @return  array
 */
function get_seller_slide()
{

        $sql = "SELECT * FROM ".$GLOBALS['ecs']->table('seller_shopslide') .' WHERE seller_id = \''.$_SESSION['seller_id'].'\'';
